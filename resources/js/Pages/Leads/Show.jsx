...
import Chat from "@/Pages/Leads/Chat";

export default function Show() {
    const { lead, followups = [], auth } = usePage().props;
            ...
            <div className="max-w-5xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link
                       ...
                       dark:bg-gray-700 dark:text-white px-4 py-2 rounded"
                    >
                        ← Back
                    </Link>
                </div>
                ...
                {/* Chat (Real-time) */}
                <Chat leadId={lead.id} user={auth.user} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 mt-6">
                    ...
                    <div>
                        <p>
                            <strong>Owner:</strong> {lead.owner?.name || "—"}
                        </p>
                        <p>
